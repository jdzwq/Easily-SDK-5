...
extern "C" {
	...
	XDL_API link_t_ptr create_file_table(const tchar_t* fname, dword_t fmode);
	...
	//XDL_API void set_file_table_block_dirty(link_t_ptr pt, int pos, bool_t b_dirty);

	//XDL_API bool_t get_file_table_block_dirty(link_t_ptr pt, int pos);

	//XDL_API void set_file_table_block_tag(link_t_ptr pt, int pos, byte_t tag);

	//XDL_API byte_t get_file_table_block_tag(link_t_ptr pt, int pos);

...
#define VARIANT_HEAD_SIZE	(sizeof(variant_head) + 4)

#define VARIANT_GET_TYPE(var)	GET_BYTE((var), 0)
#define VARIANT_SET_TYPE(var,n)	PUT_BYTE((var),0,n)

#define VARIANT_GET_SIZE(var)	GET_SWORD_LOC((var), sizeof(variant_head))
#define VARIANT_SET_SIZE(var,n)	SET_SWORD_LOC((var), sizeof(variant_head),n)

#define VARIANT_GET_PREC(var)	GET_SWORD_LOC((var), (sizeof(variant_head) + 2))
#define VARIANT_SET_PREC(var,n)	SET_SWORD_LOC((var),(sizeof(variant_head) + 2),n)

#define VARIANT_GET_BUFF(var)		(var + sizeof(variant_head) + 4)
...
variant_t variant_alloc(int encode)
{
	...
	pobj = bytes_alloc();
	bytes_realloc(pobj, VARIANT_HEAD_SIZE);

	VARIANT_SET_TYPE(*pobj, VV_NULL);
	VARIANT_SET_SIZE(*pobj, VV_NULL);

...
@RETURN void: none.
*/
EXP_API void	svg_draw_arc(canvas_t canv, const xpen_t* pxp, const xpoint_t* ppt1, const xpoint_t* ppt2, float rx, float ry, bool_t sflag, bool_t lflag);
EXP_API void	svg_draw_arc_raw(link_t_ptr g, const xpen_t* pxp, const xpoint_t* ppt1, const xpoint_t* ppt2, int rx, int ry, bool_t sflag, bool_t lflag);
...
EXP_API void	svg_color_out_raw(link_t_ptr g, const xrect_t* pxr, bool_t horz, const tchar_t* rgbstr, int len);

/***********************************************************************
	...
	@module	xdlsock.h | socket interface file
...
typedef int(__cdecl *PF_SOCKETACCEPT)(xhand_t socket, void* param);

XDL_API bool_t host_addr(const tchar_t* host,tchar_t* addr);

XDL_API xhand_t  xsocket_cli(bool_t secu, short port,const tchar_t* addr);

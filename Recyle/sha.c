...
static int get_testcase(   int test_case,
...
void sha1   (
            unsigned char *msg, //*message changed by zwq at 2014.10.28
            int message_length,
            unsigned char *digest
            )
{
...
unsigned char* message; //added by zwq at 2014.10.28
...
int x,y;
	...
	//added by zwq at 2014.10.25
	message = (unsigned char*)calloc(1,num_blocks * 64);
	memcpy((void*)message,(void*)msg,message_length);

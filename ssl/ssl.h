...
#define ERR_SSL_BAD_INPUT_DATA                    -0x1800
#define ERR_SSL_INVALID_MAC                       -0x2000
#define ERR_SSL_INVALID_RECORD                    -0x2800
#define ERR_SSL_INVALID_MODULUS_SIZE              -0x3000
#define ERR_SSL_UNKNOWN_CIPHER                    -0x3800
#define ERR_SSL_NO_CIPHER_CHOSEN                  -0x4000
#define ERR_SSL_NO_SESSION_FOUND                  -0x4800
#define ERR_SSL_NO_CLIENT_CERTIFICATE             -0x5000
#define ERR_SSL_CERTIFICATE_TOO_LARGE             -0x5800
#define ERR_SSL_CERTIFICATE_REQUIRED              -0x6000
#define ERR_SSL_PRIVATE_KEY_REQUIRED              -0x6800
#define ERR_SSL_CA_CHAIN_REQUIRED                 -0x7000
#define ERR_SSL_UNEXPECTED_MESSAGE                -0x7800
#define ERR_SSL_FATAL_ALERT_MESSAGE               -0x8000
#define ERR_SSL_PEER_VERIFY_FAILED                -0x8800
#define ERR_SSL_PEER_CLOSE_NOTIFY                 -0x9000
#define ERR_SSL_BAD_HS_CLIENT_HELLO               -0x9800
#define ERR_SSL_BAD_HS_SERVER_HELLO               -0xA000
#define ERR_SSL_BAD_HS_CERTIFICATE                -0xA800
#define ERR_SSL_BAD_HS_CERTIFICATE_REQUEST        -0xB000
#define ERR_SSL_BAD_HS_SERVER_KEY_EXCHANGE        -0xB800
#define ERR_SSL_BAD_HS_SERVER_HELLO_DONE          -0xC000
#define ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE        -0xC800
#define ERR_SSL_BAD_HS_CERTIFICATE_VERIFY         -0xD000
#define ERR_SSL_BAD_HS_CHANGE_CIPHER_SPEC         -0xD800
#define ERR_SSL_BAD_HS_FINISHED                   -0xE000
 ...
 */
extern int ssl_init( ssl_context *ssl );
 ...
 */
extern void ssl_set_endpoint( ssl_context *ssl, int endpoint );
 ...
 */
extern void ssl_set_authmode( ssl_context *ssl, int authmode );
 ...
 */
extern void ssl_set_rng( ssl_context *ssl,
                  int (*f_rng)(void *),
                  void *p_rng );
 ...
 */
extern void ssl_set_dbg( ssl_context *ssl,
                  void (*f_dbg)(void *, int, char *),
                  void  *p_dbg );
 ...
 */
extern void ssl_set_bio( ssl_context *ssl,
 ...
 */
extern void ssl_set_scb( ssl_context *ssl,
 ...
 */
extern void ssl_set_session( ssl_context *ssl, int resume, int timeout,
                      ssl_session *session );
 ...
 */
extern void ssl_set_ciphers( ssl_context *ssl, int *ciphers );
 ...
 */
extern void ssl_set_ca_chain( ssl_context *ssl, x509_cert *ca_chain,
                       char *peer_cn );
 ...
 */
extern void ssl_set_own_cert( ssl_context *ssl, x509_cert *own_cert,
                       rsa_context *rsa_key );
 ...
 */
extern int ssl_set_dh_param( ssl_context *ssl, char *dhm_P, char *dhm_G );
 ...
 * \return         0 if successful
 */
extern int ssl_set_hostname( ssl_context *ssl, char *hostname );
 ...
 */
extern int ssl_get_bytes_avail( ssl_context *ssl );
 ...
 *                      BADCERT_NOT_TRUSTED
 */
extern int ssl_get_verify_result( ssl_context *ssl );
 ...
 */
extern char *ssl_get_cipher( ssl_context *ssl );
 ...
 * \param ssl      SSL context
 *
 * \return         0 if successful, ERR_NET_TRY_AGAIN,
 *                 or a specific SSL error code.
 */
extern int ssl_handshake( ssl_context *ssl );
 ...
 */
extern int ssl_read( ssl_context *ssl, unsigned char *buf, int len );
 ...
 *                 or a negative error code.
 *
 * \note           When this function returns ERR_NET_TRY_AGAIN,
 *                 it must be called later with the *same* arguments,
 *                 until it returns a positive value.
 */
extern int ssl_write( ssl_context *ssl, unsigned char *buf, int len );

/**
 * \brief          Notify the peer that the connection is being closed
 */
extern int ssl_close_notify( ssl_context *ssl );
 ...
 */
extern int ssl_handshake_client( ssl_context *ssl );
extern int ssl_handshake_server( ssl_context *ssl );

extern int ssl_derive_keys( ssl_context *ssl );
extern void ssl_calc_verify( ssl_context *ssl, unsigned char hash[36] );

extern int ssl_read_record( ssl_context *ssl );
extern int ssl_fetch_input( ssl_context *ssl, int nb_want );

extern int ssl_write_record( ssl_context *ssl );
extern int ssl_flush_output( ssl_context *ssl );

extern int ssl_parse_certificate( ssl_context *ssl );
extern int ssl_write_certificate( ssl_context *ssl );

extern int ssl_parse_change_cipher_spec( ssl_context *ssl );
extern int ssl_write_change_cipher_spec( ssl_context *ssl );

extern int ssl_parse_finished( ssl_context *ssl );
extern int ssl_write_finished( ssl_context *ssl );

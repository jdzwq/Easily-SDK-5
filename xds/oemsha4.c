...
{                                                       \
    (n) = ( (unsigned LONGINT) (b)[(i)    ] << 56 )       \
        | ( (unsigned LONGINT) (b)[(i) + 1] << 48 )       \
        | ( (unsigned LONGINT) (b)[(i) + 2] << 40 )       \
        | ( (unsigned LONGINT) (b)[(i) + 3] << 32 )       \
        | ( (unsigned LONGINT) (b)[(i) + 4] << 24 )       \
        | ( (unsigned LONGINT) (b)[(i) + 5] << 16 )       \
        | ( (unsigned LONGINT) (b)[(i) + 6] <<  8 )       \
        | ( (unsigned LONGINT) (b)[(i) + 7]       );      \
}
#endif
...
* Round constants
*/
static const unsigned LONGINT K[80] =
{
...
{
	int i;
	unsigned LONGINT temp1, temp2, W[80];
	unsigned LONGINT A, B, C, D, E, F, G, H;
...
void sha4_update(sha4_context *ctx, unsigned char *input, int ilen)
{
	...
	if (ctx->total[0] < (unsigned LONGINT) ilen)
		ctx->total[1]++;

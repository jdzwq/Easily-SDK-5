...
typedef struct ecdh_context
{
	...
	ecp_restart_ctx rs; /*!< The restart context for EC computations. */
#endif /* MBEDTLS_ECP_RESTARTABLE */
#else
	uint8_t point_format;       /*!< The format of point export in TLS messages
								as defined in RFC 4492. */
	ecp_group_id grp_id;/*!< The elliptic curve used. */
	ecdh_variant var;   /*!< The ECDH implementation/structure used. */
	union
	{
		ecdh_context_mbed   mbed_ecdh;
...
extern "C" {
	...
	*/
	EXP_API int ecdh_make_params(ecdh_context *ctx, size_t *olen,
	...
	* \return          Another \c MBEDTLS_ERR_ECP_XXX error code on failure.
	*/
	EXP_API int ecdh_make_public(ecdh_context *ctx, size_t *olen,
		unsigned char *buf, size_t blen,
		int(*f_rng)(void *, unsigned char *, size_t),
		void *p_rng);
	...
	* \return      An \c MBEDTLS_ERR_ECP_XXX error code on failure.
	*/
	EXP_API int ecdh_read_public(ecdh_context *ctx, const unsigned char *buf, size_t blen);
	...
	* \return          Another \c MBEDTLS_ERR_ECP_XXX error code on failure.
	*/
	EXP_API int ecdh_calc_secret(ecdh_context *ctx, size_t *olen,
		unsigned char *buf, size_t blen,
		int(*f_rng)(void *, unsigned char *, size_t),
		void *p_rng);

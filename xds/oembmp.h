/***********************************************************************
	...
	@module	oembmp.h | interface file
...
extern "C" {
	...
	EXP_API bool_t xbmp_get_size(xsize_t* ps, const unsigned char* src, unsigned long len);
	
	EXP_API bool_t xbmp_get_rgb(xcolor_t* pc, int row, int col, const unsigned char* src, unsigned long len);

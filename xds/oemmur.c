...
/*****************************************************************************/
void murhash32(const uint8_t *in, const size_t inlen, uint8_t out[4])
{
	*((uint32_t*)out) = MurmurHash3_x86_32((void*)in, (int)inlen, (uint32_t)inlen);
}

void murhash128(const uint8_t *in, const size_t inlen, uint8_t out[16])
{
	MurmurHash3_x86_128((void*)in, (int)inlen, (uint32_t)inlen, (void*)out);
}

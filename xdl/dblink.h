/***********************************************************************
	...
	@module	dblink.h | interface file
...
@RETURN void: none.
*/
EXP_API void init_root_link(link_t_ptr root);
...
*/
EXP_API bool_t is_empty_link(link_t_ptr root);
...
*/
EXP_API bool_t is_root_link(link_t_ptr plk);
...
*/
EXP_API bool_t is_first_link(link_t_ptr plk);
...
*/
EXP_API bool_t is_last_link(link_t_ptr plk);
...
*/
EXP_API bool_t is_child_link(link_t_ptr root, link_t_ptr plk);
...
@RETURN void: none.
*/
EXP_API void insert_link_before(link_t_ptr root,link_t_ptr pos,link_t_ptr pnew);
...
@RETURN void: none.
*/
EXP_API void insert_link_after(link_t_ptr root,link_t_ptr pos,link_t_ptr pnew);
...
*/
EXP_API link_t_ptr delete_link(link_t_ptr root, link_t_ptr plk);
...
*/
EXP_API int get_link_count(link_t_ptr root);
...
*/
EXP_API link_t_ptr get_link_at(link_t_ptr root,int index);
...
@RETURN void: none.
*/
EXP_API void insert_link_at(link_t_ptr root, int index, link_t_ptr pnew);
...
*/
EXP_API link_t_ptr delete_link_at(link_t_ptr root, int index);
...
*/
EXP_API int get_link_index(link_t_ptr root,link_t_ptr plk);
...
*/
EXP_API link_t_ptr get_first_link(link_t_ptr root);
...
*/
EXP_API link_t_ptr get_next_link(link_t_ptr plk);
...
*/
EXP_API link_t_ptr get_prev_link(link_t_ptr plk);
...
*/
EXP_API link_t_ptr get_last_link(link_t_ptr root);
...
*/
EXP_API link_t_ptr get_root_link(link_t_ptr plk);
...
@RETURN void: none.
*/
EXP_API void merge_link(link_t_ptr root_dst, link_t_ptr root_src);
...
@RETURN void: none.
*/
EXP_API void push_link(link_t_ptr root,link_t_ptr plk);
...
*/
EXP_API link_t_ptr pop_link(link_t_ptr root);
...
@RETURN link_t_ptr: return the link if exists, otherwise return NULL.
*/
EXP_API link_t_ptr peek_link(link_t_ptr root);
...
@RETURN void: none.
*/
EXP_API void switch_link(link_t_ptr root,link_t_ptr plk1,link_t_ptr plk2);
...
@RETURN void: none.
*/
EXP_API void switch_link_next(link_t_ptr root, link_t_ptr plk);
...
@RETURN void: none.
*/
EXP_API void switch_link_prev(link_t_ptr root, link_t_ptr plk);
...
@RETURN void: none.
*/
EXP_API void switch_link_first(link_t_ptr root, link_t_ptr plk);
...
@RETURN void: none.
*/
EXP_API void switch_link_last(link_t_ptr root, link_t_ptr plk);
...
@RETURN void: none.
*/
EXP_API void switch_link_before(link_t_ptr root, link_t_ptr next, link_t_ptr plk);
...
@RETURN void: none.
*/
EXP_API void switch_link_after(link_t_ptr root, link_t_ptr prev, link_t_ptr plk);

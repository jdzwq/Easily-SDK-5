...
@RETURN void: none.
*/
EXP_API void	calc_text_rect(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const tchar_t* txt, int len, xrect_t* pxr);
...
@RETURN void: none.
*/
EXP_API void	draw_var_text(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, string_t var);
...
@RETURN void: none.
*/
EXP_API void	draw_tag_text(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr tag, int page);
...
*/
EXP_API int		calc_tag_pages(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo);
...
@RETURN void: none.
*/
EXP_API void draw_memo_text(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo, int page);
...
@RETURN int: return total pages.
*/
EXP_API int		calc_memo_pages(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo);
...
@RETURN void: none.
*/
EXP_API void	draw_rich_text(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr rich, int page);
...
@RETURN int: return total pages.
*/
EXP_API int		calc_rich_pages(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr rich);

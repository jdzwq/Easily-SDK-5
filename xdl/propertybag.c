/***********************************************************************
	...
	@doc propertybag document

	@module	propertybag.c | property bag document implement file
...
void propertybag_parse_stylesheet(link_t_ptr ptr,const tchar_t* str)
{	
	link_t_ptr ent;
	xpen_t xp = {0};
	xbrush_t xb = {0};
...
int propertybag_format_stylesheet(link_t_ptr ptr,tchar_t* buf,int len)
{
	xpen_t xp = {0};
	xbrush_t xb = {0};
	xfont_t xf = {0};
...
void propertybag_write_images_attributes(link_t_ptr ptr, link_t_ptr imagelist)
{
	link_t_ptr ent;
...
void propertybag_read_images_attributes(link_t_ptr ptr, link_t_ptr imagelist)
{
...
void propertybag_write_images_item_attributes(link_t_ptr ptr, link_t_ptr imageitem)
{
	link_t_ptr ent;
...
void propertybag_read_images_item_attributes(link_t_ptr ptr, link_t_ptr imageitem)
{
...
void propertybag_write_form_attributes(link_t_ptr ptr, link_t_ptr form)
{
	link_t_ptr ent;
...
void propertybag_read_form_attributes(link_t_ptr ptr, link_t_ptr form)
{
...
void propertybag_write_field_attributes(link_t_ptr ptr, link_t_ptr flk)
{
...
void propertybag_read_field_attributes(link_t_ptr ptr, link_t_ptr flk)
{
	const tchar_t* sz_class;
...
void propertybag_write_grid_attributes(link_t_ptr ptr, link_t_ptr grid)
{
	link_t_ptr ent;
...
void propertybag_read_grid_attributes(link_t_ptr ptr, link_t_ptr grid)
{
...
void propertybag_write_col_attributes(link_t_ptr ptr, link_t_ptr clk)
{
	link_t_ptr ent;
...
void propertybag_read_col_attributes(link_t_ptr ptr, link_t_ptr clk)
{
...
void propertybag_write_graph_attributes(link_t_ptr ptr, link_t_ptr graph)
{
	link_t_ptr ent;
...
void propertybag_read_graph_attributes(link_t_ptr ptr, link_t_ptr graph)
{
...
void propertybag_write_gax_attributes(link_t_ptr ptr, link_t_ptr glk)
{
	link_t_ptr ent;
...
void propertybag_read_gax_attributes(link_t_ptr ptr, link_t_ptr glk)
{
...
void propertybag_write_yax_attributes(link_t_ptr ptr, link_t_ptr ylk)
{
	link_t_ptr ent;
...
void propertybag_read_yax_attributes(link_t_ptr ptr, link_t_ptr ylk)
{
...
void propertybag_write_topog_attributes(link_t_ptr ptr, link_t_ptr topog, int row, int col)
{
	link_t_ptr ent;
	int val;
...
void propertybag_read_topog_attributes(link_t_ptr ptr, link_t_ptr topog)
{
	link_t_ptr sec;
	int row, col;
	int val;
...
void propertybag_write_topog_spot_attributes(link_t_ptr ptr, link_t_ptr ilk)
{
	link_t_ptr ent;
...
void propertybag_read_topog_spot_attributes(link_t_ptr ptr, link_t_ptr ilk)
{
...
void propertybag_write_rich_attributes(link_t_ptr ptr, link_t_ptr rich)
{
	link_t_ptr ent;
...
void propertybag_read_rich_attributes(link_t_ptr ptr, link_t_ptr rich)
{
...
void propertybag_read_dialog_attributes(link_t_ptr ptr, link_t_ptr dialog)
{
...
void propertybag_write_dialog_item_attributes(link_t_ptr ptr, link_t_ptr ilk)
{
	link_t_ptr ent;
	const tchar_t* sz_class;
...
void propertybag_read_dialog_item_attributes(link_t_ptr ptr, link_t_ptr ilk)
{
...
void propertybag_write_chart_attributes(link_t_ptr ptr, link_t_ptr chart)
{
	link_t_ptr ent;
...
void propertybag_read_chart_attributes(link_t_ptr ptr, link_t_ptr chart)
{
...
void propertybag_write_chart_table_attributes(link_t_ptr ptr, link_t_ptr ilk)
{
	link_t_ptr ent;
	const tchar_t* sz_class;
...
void propertybag_read_chart_table_attributes(link_t_ptr ptr, link_t_ptr ilk)
{
	const tchar_t* sz_class;

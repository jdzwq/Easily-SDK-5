...
void calc_text_rect_raw(const if_visual_t* piv, const xfont_t* pxf, const xface_t* pxa, const tchar_t* sz_text, int sz_len, xrect_t* pxr)
{
	FIXTEXT_SCAN tt = { 0 };
	if_measure_t im = { 0 };
	...
	(*piv->pf_get_measure_raw)(piv->visual, &im);
...
void calc_text_rect(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const tchar_t* txt, int len, xrect_t* pxr)
{
	xrect_t xr = { 0 };
	if_visual_t iv = { 0 };

	(*pif->pf_get_visual_interface)(pif->canvas, &iv);

	calc_text_rect_raw(&iv, pxf, pxa, txt, len, &xr);

	(pif->pf_rect_pt_to_tm)(pif->canvas, &xr);

	xmem_copy((void*)pxr, (void*)&xr, sizeof(xrect_t));
}

typedef struct _VARTEXT_DRAW{
	const if_visual_t* piv;
	int page;
}VARTEXT_DRAW;
...
static int _var_text_calc_draw(int scan, void* object, bool_t b_atom, bool_t b_ins, bool_t b_del, bool_t b_sel, const tchar_t* cur_char, int cur_count, tchar_t* ret_char, int page, int cur_row, int cur_col, const WORDPLACE* ptm, const xfont_t* pxf, const xface_t* pxa, void* pp)
{
	...
	case _SCANNER_STATE_WORDS:
		...
		(*(ptt->piv->pf_text_out_raw))(ptt->piv->visual, pxf, &pt, cur_char, cur_count);
		break;
	case _SCANNER_STATE_END:
		return _SCANNER_OPERA_STOP;
	}
...
void draw_var_text_raw(const if_visual_t* piv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, string_t data)
{
	VARTEXT_DRAW tt = { 0 };
	if_measure_t im = { 0 };
...
void draw_var_text(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, string_t var)
{
	xrect_t xr;
	if_visual_t iv = { 0 };
...
void draw_tag_text_raw(const if_visual_t* piv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr data, int page)
{
	TAGTEXT_DRAW tt = { 0 };
	if_measure_t im = { 0 };
...
void draw_tag_text(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr tag, int page)
{
	xrect_t xr;
	if_visual_t iv = { 0 };
...
int calc_tag_pages_raw(const if_visual_t* piv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr data)
{
	TAGTEXT_PAGE tt = { 0 };
	if_measure_t im = { 0 };
...
int calc_tag_pages(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr tag)
{
	xrect_t xr;
	if_visual_t iv = { 0 };
...
void draw_memo_text_raw(const if_visual_t* piv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr data, int page)
{
	MEMOTEXT_DRAW tt = { 0 };
	if_measure_t im = { 0 };
...
void draw_memo_text(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo, int page)
{
	xrect_t xr;
	if_visual_t iv = { 0 };
...
int calc_memo_pages_raw(const if_visual_t* piv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr data)
{
	MEMOTEXT_PAGE tt = { 0 };
	if_measure_t im = { 0 };
...
int calc_memo_pages(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo)
{
	xrect_t xr;
	if_visual_t iv = { 0 };
...
void draw_rich_text_raw(const if_visual_t* piv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr data, int page)
{
	RICHTEXT_DRAW tt = { 0 };
	if_measure_t im = { 0 };
...
void draw_rich_text(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr rich, int page)
{
	xrect_t xr;
	if_visual_t iv = { 0 };
...
int calc_rich_pages_raw(const if_visual_t* piv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr data)
{
	RICHTEXT_PAGE tt = { 0 };
	if_measure_t im = { 0 };
...
int calc_rich_pages(const if_canvas_t* pif, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr rich)
{
	xrect_t xr;
	if_visual_t iv = { 0 };

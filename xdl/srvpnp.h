/***********************************************************************
	...
	@module	srvpnp.h | interface file
...
*/
EXP_API pnp_listen_t*  xpnp_start_thread(unsigned short port, PF_PNPS_DISPATCH pf_dispatch, void* param);
...
@RETURN pnp_listen_t*: if succeeds return listen struct, fails return NULL.
*/
EXP_API pnp_listen_t*  xpnp_start_process(unsigned short port, const tchar_t* sz_module, tchar_t* sz_cmdline);
...
@RETURN void: none.
*/
EXP_API void  xpnp_stop(pnp_listen_t* plis);

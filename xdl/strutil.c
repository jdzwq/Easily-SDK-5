...
int w_parse_string_array_count(const wchar_t* tokens)
{
	int count = 0;
	int len;
...
int a_parse_string_array_count(const schar_t* tokens)
{
	int count = 0;
	int len;
...
int w_parse_string_array(const wchar_t* tokens, wchar_t** sa, int n)
{
	int len, i = 0;
...
int a_parse_string_array(const schar_t* tokens, schar_t** sa, int n)
{
	int len, i = 0;
...
int w_format_string_array(const wchar_t** sa, int n, wchar_t* tokens, int max)
{
	int len, i, total = 0;
...
int a_format_string_array(const schar_t** sa, int n, schar_t* tokens, int max)
{
	int len, i, total = 0;

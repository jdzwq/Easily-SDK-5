/***********************************************************************
	...
	@module	soapdoc.h | interface file
...
*/
EXP_API link_t_ptr create_soap_doc(void);
...
@RETURN void: none.
*/
EXP_API void destroy_soap_doc(link_t_ptr ptr);
...
*/
EXP_API bool_t is_soap_doc(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void set_soap_default_xmlns(link_t_ptr ptr);
...
*/
EXP_API link_t_ptr get_soap_head_node(link_t_ptr ptr);
...
*/
EXP_API link_t_ptr get_soap_body_node(link_t_ptr ptr);
...
*/
EXP_API link_t_ptr get_soap_request_node(link_t_ptr ptr);
...
*/
EXP_API link_t_ptr set_soap_request_node(link_t_ptr ptr, const tchar_t* sz_req, const tchar_t* sz_ns, const tchar_t* sz_url);
...
*/
EXP_API link_t_ptr set_soap_request_param(link_t_ptr nlk, const tchar_t* pname, const tchar_t* ptype, void* pdata, int n);
...
*/
EXP_API int get_soap_request_param(link_t_ptr nlk, const tchar_t* pname, const tchar_t* ptype, void* pdata, int max);
...
*/
EXP_API link_t_ptr get_soap_response_node(link_t_ptr ptr);
...
*/
EXP_API link_t_ptr set_soap_response_node(link_t_ptr ptr, const tchar_t* sz_res, const tchar_t* sz_ns, const tchar_t* sz_url);
...
@RETURN link_t_ptr: return the soap parameter node link component.
*/
EXP_API link_t_ptr set_soap_response_param(link_t_ptr nlk, const tchar_t* pname, const tchar_t* ptype, void* pdata, int n);
...
@RETURN int: return the soap parameter node text value length or array size.
*/
EXP_API int get_soap_response_param(link_t_ptr nlk, const tchar_t* pname, const tchar_t* ptype, void* pdata, int max);
...
*/
EXP_API link_t_ptr set_soap_fault_node(link_t_ptr ptr);
...
*/
EXP_API link_t_ptr get_soap_fault_node(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void set_soap_fault_code(link_t_ptr nlk, const tchar_t* sz_code);
...
@RETURN void: none.
*/
EXP_API void set_soap_fault_string(link_t_ptr nlk, const tchar_t* sz_text);
...
*/
EXP_API int get_soap_fault_code(link_t_ptr nlk, tchar_t* buf, int max);
...
*/
EXP_API int get_soap_fault_string(link_t_ptr nlk, tchar_t* buf, int max);

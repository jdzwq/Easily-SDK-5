...
@RETURN void: none.
*/
XDL_API void copy_hash_table(link_t_ptr ptr_dst, link_t_ptr ptr_src);
...
*/
XDL_API const tchar_t* hash_attr_set_chars(link_t_ptr elk, const tchar_t* key, int pos, const tchar_t* pch, int n);
...
@RETURN const tchar_t*: return hash entity string token if exists, otherwise return NULL.
*/
XDL_API const tchar_t* hash_attr_ins_chars(link_t_ptr elk, const tchar_t* key, int pos, const tchar_t* pch, int n);
...
@RETURN const tchar_t*: return hash entity string token if exists, otherwise return NULL.
*/
XDL_API const tchar_t* hash_attr_del_chars(link_t_ptr elk, const tchar_t* key, int pos, int n);

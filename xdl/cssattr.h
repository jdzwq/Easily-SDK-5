...
#define CSS_TEXT_JUSTIFY_OPTIONS		_T("0~auto;1~distribute;2~distribute-all-lines;3~distribute-center-last;4~inter-cluster;5~inter-ideostatis;6~inter-word;7~kashida;8~newspaper;")
...
#define CSS_TEXT_JUSTIFY_INTERIDEOSTATIS	_T("inter-odeostatis")

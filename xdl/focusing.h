...
@INPUT if_visual_t* piv: the context interface.
...
@RETURN void: none.
*/
EXP_API void	draw_select_raw(const if_visual_t* piv, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
EXP_API void	draw_focus_raw(const if_visual_t* piv, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
EXP_API void	draw_feed_raw(const if_visual_t* piv, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
EXP_API void	draw_sizing_raw(const if_visual_t* piv, const xcolor_t* pxc, const xrect_t* prt, int deep, dword_t pos);

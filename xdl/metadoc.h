...
*/
EXP_API link_t_ptr create_meta_doc();
...
@RETURN void: none.
*/
EXP_API void destroy_meta_doc(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void clear_meta_doc(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void clear_meta_head_nodes(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void clear_meta_body_nodes(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void set_meta_doc_name(link_t_ptr ptr, const tchar_t* sz_name);
...
*/
EXP_API const tchar_t* get_meta_doc_name_ptr(link_t_ptr ptr);
...
*/
EXP_API link_t_ptr get_meta_head_node(link_t_ptr ptr);
...
*/
EXP_API link_t_ptr get_meta_body_node(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void attach_meta_body_node(link_t_ptr ptr, link_t_ptr doc);
...
*/
EXP_API link_t_ptr detach_meta_body_node(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void set_meta_head_title(link_t_ptr ptr, const tchar_t* sz_title, int len);
...
*/
EXP_API int get_meta_head_title(link_t_ptr ptr, tchar_t* sz_buf, int max);
...
*/
EXP_API const tchar_t* get_meta_head_title_ptr(link_t_ptr ptr);
...
@RETURN void: none.
*/
EXP_API void set_meta_head_meta(link_t_ptr ptr, const tchar_t* sz_name, int nlen, const tchar_t* sz_content, int clen);
...
*/
EXP_API int get_meta_head_meta(link_t_ptr ptr, const tchar_t* sz_name, int nlen, tchar_t* sz_buf, int max);
...
*/
EXP_API const tchar_t* get_meta_head_meta_ptr(link_t_ptr ptr, const tchar_t* sz_name, int nlen);

...
*/
EXP_API stream_t stream_alloc(xhand_t io);
...
*/
EXP_API xhand_t stream_attach(stream_t xs, xhand_t io, PF_BIO_READ pf_read, PF_BIO_WRITE pf_write, PF_BIO_FLUSH pf_flush);
...
@RETURN xhand_t: return the io handle if exists, otherwise return NULL.
*/
EXP_API xhand_t stream_detach(stream_t xs);
...
@RETURN void: none.
*/
EXP_API void stream_set_encode(stream_t xs, int encode);
...
*/
EXP_API int stream_get_encode(stream_t xs);
...
@RETURN void: none.
*/
EXP_API void stream_set_mode(stream_t xs, int mode);
...
*/
EXP_API int stream_get_mode(stream_t xs);
...
@RETURN void: none.
*/
EXP_API void stream_set_size(stream_t xs, dword_t dw);
...
*/
EXP_API dword_t stream_get_size(stream_t xs);
...
*/
EXP_API bool_t stream_read_chunk_size(stream_t xs, dword_t* pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_chunk_size(stream_t xs, dword_t dw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write(stream_t xs, const tchar_t* buf, int len, dword_t* pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_flush(stream_t xs);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read(stream_t xs, tchar_t* buf, int len, dword_t* pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_char(stream_t xs, const tchar_t* buf, dword_t* pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read_char(stream_t xs, tchar_t* buf, dword_t* pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read_escape(stream_t xs, tchar_t* buf, dword_t* pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_escape(stream_t xs, tchar_t ch, dword_t* pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_bytes(stream_t xs, const byte_t* buf, dword_t len);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read_bytes(stream_t xs, byte_t* buf, dword_t *pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_sword_lit(stream_t xs, sword_t sw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_sword_big(stream_t xs, sword_t sw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read_sword_lit(stream_t xs, sword_t* psw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read_sword_big(stream_t xs, sword_t* psw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_dword_lit(stream_t xs, dword_t dw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_dword_big(stream_t xs, dword_t dw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read_dword_lit(stream_t xs, dword_t* pdw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read_dword_big(stream_t xs, dword_t* pdw);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_write_utfbom(stream_t xs, dword_t* pch);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_read_utfbom(stream_t xs, dword_t* pch);
...
*/
EXP_API dword_t stream_printf(stream_t xs, const tchar_t* fmt, ...);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t stream_copy(stream_t xs_src, stream_t xs_dst);
...
@RETURN void: none.
*/
EXP_API void stream_opera_reset(stream_t xs);

...
#define HTTP_HEADER_TYPE_IMAGEJPG			_T("image/jpeg")
#define HTTP_HEADER_TYPE_IMAGEPNG			_T("image/png")
#define HTTP_HEADER_TYPE_IMAGEGIF			_T("image/gif")
#define HTTP_HEADER_TYPE_IMAGEBMP			_T("image/bmp")
#define HTTP_HEADER_TYPE_IMAGESVG			_T("image/svg+xml")
#define HTTP_HEADER_TYPE_VIDEOMPG			_T("video/mpeg")
#define HTTP_HEADER_TYPE_VIDEOAVI			_T("video/avi")
#define HTTP_HEADER_TYPE_AUDIOMP3			_T("audio/mp3")
#define HTTP_HEADER_TYPE_APPPDF				_T("application/pdf")
#define HTTP_HEADER_TYPE_APPXML				_T("application/xml")
#define HTTP_HEADER_TYPE_APPSOAP			_T("application/soap+xml")
#define HTTP_HEADER_TYPE_APPJSON				_T("application/xml")
#define HTTP_HEADER_TYPE_APPJSON_GB2312		_T("application/json; charset=gb2312;")
#define HTTP_HEADER_TYPE_APPJSON_UTF8		_T("application/json; charset=utf-8;")
#define HTTP_HEADER_TYPE_TEXTXML			_T("text/xml")
#define HTTP_HEADER_TYPE_TEXTXML_GB2312		_T("text/xml; charset=gb2312;")
#define HTTP_HEADER_TYPE_TEXTXML_UTF8		_T("text/xml; charset=utf-8;")
#define HTTP_HEADER_TYPE_TEXTHTML			_T("text/html")
#define HTTP_HEADER_TYPE_TEXTPLAIN			_T("text/plain")
#define HTTP_HEADER_TYPE_TEXTPLAIN_GB2312	_T("text/plain; charset=gb2312;")
#define HTTP_HEADER_TYPE_TEXTPLAIN_UTF8		_T("text/plain; charset=utf-8;")

/***********************************************************************
	...
	@module	domdoc.h | interface file
...
*/
EXP_API link_t_ptr create_dom_doc(void);
...
@RETURN void: none.
*/
EXP_API void destroy_dom_doc(link_t_ptr ptr);
...
*/
EXP_API bool_t is_dom_child_node(link_t_ptr ilk, link_t_ptr plk);
...
*/
EXP_API bool_t is_dom_doc_node(link_t_ptr ilk);
...
*/
EXP_API bool_t is_dom_node_attr(link_t_ptr ilk, const tchar_t* key, int len);
...
*/
EXP_API link_t_ptr get_dom_from_node(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void attach_dom_node(link_t_ptr ilk, link_t_ptr pos, link_t_ptr pnew);
...
*/
EXP_API link_t_ptr detach_dom_node(link_t_ptr ilk, link_t_ptr pos);
...
*/
EXP_API link_t_ptr insert_dom_node_before(link_t_ptr ilk, link_t_ptr pos);
...
@RETURN link_t_ptr: return the new link component inserted.
*/
EXP_API link_t_ptr insert_dom_node(link_t_ptr ilk, link_t_ptr pos);
...
@RETURN void: none.
*/
EXP_API void delete_dom_node(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void delete_dom_child_nodes(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void merge_dom_child_nodes(link_t_ptr dst, link_t_ptr src);
...
*/
EXP_API link_t_ptr get_dom_child_node_root(link_t_ptr ilk);
...
*/
EXP_API int get_dom_child_node_count(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void sort_dom_child_node_by_name(link_t_ptr ilk, int desc);
...
@RETURN void: none.
*/
EXP_API void sort_dom_child_node_by_text(link_t_ptr ilk, int desc);
...
@RETURN void: none.
*/
EXP_API void sort_dom_child_node_by_attr(link_t_ptr ilk, const tchar_t* attr, int desc);
...
*/
EXP_API link_t_ptr get_dom_first_child_node(link_t_ptr ilk);
...
@RETURN link_t_ptr: return the node link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr get_dom_last_child_node(link_t_ptr ilk);
...
*/
EXP_API link_t_ptr get_dom_parent_node(link_t_ptr ilk);
...
@RETURN link_t_ptr: return the node link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr get_dom_next_sibling_node(link_t_ptr ilk);
...
@RETURN link_t_ptr: return the node link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr get_dom_prev_sibling_node(link_t_ptr ilk);
...
*/
EXP_API int get_dom_node_level(link_t_ptr ilk);
...
@RETURN link_t_ptr: return the node link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr get_dom_child_node_at(link_t_ptr ilk, int index);
...
@RETURN link_t_ptr: return the node link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr find_dom_node_by_name(link_t_ptr ptr, bool_t deep, const tchar_t* sz_name, int len);
...
@RETURN link_t_ptr: return the node link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr find_dom_node_by_text(link_t_ptr ptr, bool_t deep, const tchar_t* sz_text, int len);
...
@RETURN link_t_ptr: return the node link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr find_dom_node_by_attr(link_t_ptr ptr, bool_t deep, const tchar_t* sz_key, int klen, const tchar_t* sz_val, int vlen);
...
*/
EXP_API link_t_ptr get_dom_node_attr_table(link_t_ptr ilk);
...
*/
EXP_API link_t_ptr get_dom_node_options_table(link_t_ptr ilk);
...
@RETURN link_t_ptr: return the string table link component if exists, otherwise return NULL.
*/
EXP_API void set_dom_node_options(link_t_ptr ilk, const tchar_t* token, int len);
...
*/
EXP_API int get_dom_node_options_len(link_t_ptr ilk);
...
@RETURN int: return the options token length in characters if exists, otherwise return zero.
*/
EXP_API int get_dom_node_options(link_t_ptr ilk, tchar_t* buf, int max);
...
*/
EXP_API const tchar_t* get_dom_node_options_text_ptr(link_t_ptr ilk, const tchar_t* szKey, int klen);
...
@RETURN void: none.
*/
EXP_API void set_dom_node_options_text(link_t_ptr ilk, const tchar_t* szKey, int klen, const tchar_t* szVal, int vlen);
...
@RETURN void: none.
*/
EXP_API void set_dom_node_name(link_t_ptr ilk, const tchar_t* sz_name, int len);
...
*/
EXP_API const tchar_t* get_dom_node_name_ptr(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void set_dom_node_text(link_t_ptr ilk, const tchar_t* sz_text, int len);
...
*/
EXP_API int get_dom_node_text(link_t_ptr ilk, tchar_t* buf, int max);
...
*/
EXP_API const tchar_t* get_dom_node_text_ptr(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void attach_dom_node_text(link_t_ptr ilk, tchar_t* text);
...
*/
EXP_API tchar_t* detach_dom_node_text(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void attach_dom_node_attr(link_t_ptr ilk, const tchar_t* key, tchar_t* val);
...
*/
EXP_API tchar_t* detach_dom_node_attr(link_t_ptr ilk, const tchar_t* key);
...
*/
EXP_API int dom_node_text_get_chars(link_t_ptr ilk, int pos, tchar_t* pch, int n);
...
*/
EXP_API const tchar_t* dom_node_text_set_chars(link_t_ptr ilk, int pos, const tchar_t* pch, int n);
...
@RETURN const tchar_t: return the text string pointer of the node text.
*/
EXP_API const tchar_t* dom_node_text_ins_chars(link_t_ptr ilk, int pos, const tchar_t* pch, int n);
...
@RETURN const tchar_t: return the text string pointer of the node text.
*/
EXP_API const tchar_t* dom_node_text_del_chars(link_t_ptr ilk, int pos, int n);
...
*/
EXP_API const tchar_t* dom_node_attr_set_chars(link_t_ptr ilk, const tchar_t* attr, int pos, const tchar_t* pch, int n);
...
@RETURN const tchar_t: return the attrubute value string pointer of the node.
*/
EXP_API const tchar_t* dom_node_attr_ins_chars(link_t_ptr ilk, const tchar_t* attr, int pos, const tchar_t* pch, int n);
...
*/
EXP_API const tchar_t* dom_node_attr_del_chars(link_t_ptr ilk, const tchar_t* attr, int pos, int n);
...
@RETURN void: none.
*/
EXP_API void copy_dom_node(link_t_ptr dst, link_t_ptr src);
...
@RETURN void: none.
*/
EXP_API void set_dom_node_nsurl(link_t_ptr ilk, const tchar_t* sz_url, int len);
...
*/
EXP_API const tchar_t* get_dom_node_nsurl_ptr(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void set_dom_node_ns(link_t_ptr ilk, const tchar_t* ns, int len);
...
*/
EXP_API const tchar_t* get_dom_node_ns_ptr(link_t_ptr ilk);
...
*/
EXP_API link_t_ptr get_dom_node_name_table(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void set_dom_node_xmlns(link_t_ptr ilk, const tchar_t* nsname, int klen, const tchar_t* nsurl, int vlen);
...
*/
EXP_API int get_dom_node_xmlns(link_t_ptr ilk, const tchar_t* nsname, int len, tchar_t* buf, int max);
...
*/
EXP_API dword_t get_dom_node_mask(link_t_ptr ilk);
...
@RETURN void: none.
*/
EXP_API void set_dom_node_mask(link_t_ptr ilk, dword_t ul);
...
@RETURN void: none.
*/
EXP_API void set_dom_node_mask_check(link_t_ptr ilk, dword_t ul, bool_t b);
...
*/
EXP_API bool_t get_dom_node_mask_check(link_t_ptr ilk, dword_t ul);
...
*/
EXP_API int get_dom_child_node_mask_check_count(link_t_ptr ilk, dword_t ul);
...
*/
EXP_API int set_dom_child_node_mask_check(link_t_ptr ilk, dword_t ul, bool_t b);

/************************************************runtime paging function************************************/

EXP_API bool_t get_dom_node_page_cator(link_t_ptr ilk, int pos, page_cator_t* pca);

EXP_API void set_dom_node_page_cator(link_t_ptr ilk, int pos, const page_cator_t* pca);

EXP_API int get_dom_node_page_cator_count(link_t_ptr ilk);

EXP_API void del_dom_node_page_cator(link_t_ptr ilk, int page);

EXP_API bool_t get_dom_node_line_cator(link_t_ptr ilk, int point, int* pcx, int* pcy);

EXP_API void set_dom_node_line_cator(link_t_ptr ilk, int point, int cx, int cy);

EXP_API void ins_dom_node_line_cator(link_t_ptr ilk, int point, int cx, int cy);

EXP_API void del_dom_node_line_cator(link_t_ptr ilk, int point);

EXP_API void cut_dom_node_line_cator(link_t_ptr ilk, int point);;

EXP_API int get_dom_node_line_cator_count(link_t_ptr ilk);

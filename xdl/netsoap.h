...
XDL_API void set_wsdl_soap_info(link_t_ptr wsdl, const tchar_t* sz_srv, const tchar_t* sz_rpc, const tchar_t* sz_loc, const tchar_t* sz_act, const tchar_t* sz_tns, link_t_ptr req_sch, link_t_ptr res_sch);

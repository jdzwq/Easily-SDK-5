/***********************************************************************
	...
	@module	srvssl.h | interface file
...
*/
EXP_API ssl_listen_t*  xssl_start_thread(unsigned short port, PF_SSLS_DISPATCH pf_dispatch, void* param);
...
@RETURN ssl_listen_t*: if succeeds return listen struct, fails return NULL.
*/
EXP_API ssl_listen_t*  xssl_start_process(unsigned short port, const tchar_t* sz_module, tchar_t* sz_cmdline);
...
@RETURN void: none.
*/
EXP_API void  xssl_stop(ssl_listen_t* plis);

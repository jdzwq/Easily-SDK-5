 ...
 *                 is not supported.
 */
extern void rsa_init( rsa_context *ctx,
               int padding,
               int hash_id,
               int (*f_rng)(void *),
               void *p_rng );
 ...
 */
extern int rsa_gen_key( rsa_context *ctx, int nbits, int exponent );
 ...
 * \return         0 if successful, or an ERR_RSA_XXX error code
 */
extern int rsa_check_pubkey( rsa_context *ctx );
 ...
 * \return         0 if successful, or an ERR_RSA_XXX error code
 */
extern int rsa_check_privkey( rsa_context *ctx );
 ...
 */
extern int rsa_public( rsa_context *ctx,
                unsigned char *input,
 ...
 *                 enough (eg. 128 bytes if RSA-1024 is used).
 */
extern int rsa_private( rsa_context *ctx,
                 unsigned char *input,
                 unsigned char *output );
 ...
 */
extern int rsa_pkcs1_encrypt( rsa_context *ctx,
                       int mode, int  ilen,
                       unsigned char *input,
                       unsigned char *output );
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
extern int rsa_pkcs1_decrypt( rsa_context *ctx,
                       int mode, int *olen,
                       unsigned char *input,
                       unsigned char *output );
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
extern int rsa_pkcs1_sign( rsa_context *ctx,
                    int mode,
                    int hash_id,
                    int hashlen,
                    unsigned char *hash,
 ...
 */
extern int rsa_self_test( int verbose );

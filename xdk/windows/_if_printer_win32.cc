/***********************************************************************
	...
	@module	if_printer_win.c | device printer windows implement file
...
bool_t _setup_printer_mode(res_win_t wnd, dev_prn_t* pmod)
{
	...
	{
		_tstrcpy(szPrinter, (TCHAR*)pmod->devname);
	}
	else
	{
		_tstrcpy(szPrinter, _T(""));

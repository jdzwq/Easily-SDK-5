...
void _gdi_draw_arc(res_ctx_t rdc, const xpen_t* pxp, const xrect_t* prt, double fang, double tang);
void _gdi_draw_arrow(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t*pxb, const xrect_t* prt, int alen, double arc);
//void _gdi_draw_shape(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t*pxb, const xrect_t* prt, const tchar_t* shape);
//void _gdi_multi_line(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xpen_t* pxp, const xrect_t* pxr);
...
//void _gdiplus_draw_shape(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t*pxb, const xrect_t* prt, const tchar_t* shape);
//void _gdiplus_multi_line(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xpen_t* pxp, const xrect_t* pxr);

...
#define DICM_CMD_C_ECHO_RQ		0x0030
#define DICM_CMD_C_ECHO_RSP		0x8030
...
typedef struct _dicm_command_t{
	dword_t mask;
...
extern "C" {
	...
	EXP_API bool_t parse_dicm_command_from_stream(dicm_command_t* pcmd, bool_t bigEndian, dword_t maxLength, stream_t stm);

	EXP_API bool_t format_dicm_command_to_stream(dicm_command_t* pcmd, bool_t bigEndian, dword_t maxLength, stream_t stm);

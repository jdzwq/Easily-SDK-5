...
extern "C" {
	...
	EXP_API dicm_context_file* dicm_alloc_head(void);

	EXP_API void dicm_free_head(dicm_context_file* ctx);

	EXP_API void dicm_set_head_read(dicm_context_file* pdcm, void* rp, PF_DICM_READ pf_read);

	EXP_API void dicm_set_head_write(dicm_context_file* pdcm, void* wp, PF_DICM_WRITE pf_write);

	EXP_API void dicm_set_head_error(dicm_context_file* pdcm, void* ep, PF_DICM_ERROR pf_error);

	EXP_API void dicm_set_head_parse(dicm_context_file* pdcm, void* pp, PF_DICM_PARSE_HEAD pf_parse_head);

	EXP_API void dicm_set_head_format(dicm_context_file* pdcm, void* fp, PF_DICM_FORMAT_HEAD pf_format_head);

	EXP_API bool_t dicm_parse_head(dicm_context_file* pdcm);

	EXP_API bool_t dicm_format_head(dicm_context_file* pdcm);
	...
	EXP_API void dicm_set_command_read(dicm_conext_command* pdcm, void* rp, PF_DICM_READ pf_read);

	EXP_API void dicm_set_command_write(dicm_conext_command* pdcm, void* wp, PF_DICM_WRITE pf_write);

	EXP_API void dicm_set_command_error(dicm_conext_command* pdcm, void* ep, PF_DICM_ERROR pf_error);

	EXP_API void dicm_set_command_parse(dicm_conext_command* pdcm, void* pp, PF_DICM_PARSE_ITEM pf_parse_item, PF_DICM_PARSE_DATA pf_parse_data);

	EXP_API void dicm_set_command_format(dicm_conext_command* pdcm, void* fp, PF_DICM_FORMAT_ITEM pf_format_item, PF_DICM_FORMAT_DATA pf_format_data);

	EXP_API bool_t dicm_parse_command(dicm_conext_command* pdcm);

	EXP_API bool_t dicm_format_command(dicm_conext_command* pdcm);
	...
	EXP_API void dicm_set_dataset_read(dicm_context_dataset* pdcm, void* rp, PF_DICM_READ pf_read);

	EXP_API void dicm_set_dataset_write(dicm_context_dataset* pdcm, void* wp, PF_DICM_WRITE pf_write);

	EXP_API void dicm_set_dataset_error(dicm_context_dataset* pdcm, void* ep, PF_DICM_ERROR pf_error);

	EXP_API void dicm_set_dataset_parse(dicm_context_dataset* pdcm, void* pp, PF_DICM_PARSE_ITEM pf_parse_item, PF_DICM_PARSE_DATA pf_parse_data, PF_DICM_PARSE_SEQUENCE_BEGIN pf_parse_sequence_begin, PF_DICM_PARSE_SEQUENCE_END pf_parse_sequence_end, PF_DICM_PARSE_SEQUENCE_ITEM_BEGIN pf_parse_sequence_item_begin, PF_DICM_PARSE_SEQUENCE_ITEM_END pf_parse_sequence_item_end);

	EXP_API void dicm_set_dataset_format(dicm_context_dataset* pdcm, void* pp, PF_DICM_FORMAT_ITEM pf_format_item, PF_DICM_FORMAT_DATA pf_format_data, PF_DICM_FORMAT_SEQUENCE_BEGIN pf_format_sequence_begin, PF_DICM_FORMAT_SEQUENCE_END pf_format_sequence_end, PF_DICM_FORMAT_SEQUENCE_ITEM_BEGIN pf_format_sequence_item_begin, PF_DICM_FORMAT_SEQUENCE_ITEM_END pf_format_sequence_item_end);

	EXP_API bool_t dicm_parse_dataset(dicm_context_dataset* pdcm);

	EXP_API bool_t dicm_format_dataset(dicm_context_dataset* pdcm);

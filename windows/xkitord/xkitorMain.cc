...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = (LPCTSTR)IDC_XKITORD;
	wcex.lpszClassName = _T("XKITORDCLASS");
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	hWnd = CreateWindow(_T("XKITORDCLASS"), NULL, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, NULL, NULL, hInstance, NULL);
	if (!hWnd)
	{
		return FALSE;
	}

	hMenu = LoadMenu(hInst, MAKEINTRESOURCE(IDC_XKITORD));

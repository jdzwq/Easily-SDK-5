...
static FACE_STYLE g_face[FACE_COUNT] = {
	{ _T("Ì«¿ÕºÚ"), GDI_ATTR_RGB_HARDBLACK, GDI_ATTR_RGB_SOFTBLACK, GDI_ATTR_RGB_GRAY, GDI_ATTR_RGB_DARKWHITE },
	{ _T("´ºÌìÂÌ"), GDI_ATTR_RGB_LIGHTGREEN, GDI_ATTR_RGB_LIGHTCYAN, GDI_ATTR_RGB_DARKBLACK, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("ÍÁºÀ½ð"), GDI_ATTR_RGB_SOFTYELLOW, GDI_ATTR_RGB_SOFTGREEN, GDI_ATTR_RGB_DARKBLACK, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("Ï²Çìºì"), GDI_ATTR_RGB_LIGHTRED, GDI_ATTR_RGB_SOFTGREEN, GDI_ATTR_RGB_DARKBLACK, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("µ­ÑÅÇà"), GDI_ATTR_RGB_LIGHTPURPLE, GDI_ATTR_RGB_LIGHTCYAN, GDI_ATTR_RGB_DARKBLACK, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("¾­µä°×"), GDI_ATTR_RGB_LIGHTWHITE, GDI_ATTR_RGB_GRAY, GDI_ATTR_RGB_BLACK, GDI_ATTR_RGB_SOFTWHITE }
};

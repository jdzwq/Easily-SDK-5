...
static FACE_STYLE g_face[FACE_COUNT] = {
	...
	{ _T("ÍÁºÀ½ð"), GDI_ATTR_RGB_PALEYELLOW, GDI_ATTR_RGB_DARKIVORY, GDI_ATTR_RGB_DARKBLACK, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("Ï²Çìºì"), GDI_ATTR_RGB_LIGHTRED, GDI_ATTR_RGB_LIGHTCYAN, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("µ­ÑÅÇà"), GDI_ATTR_RGB_LIGHTPURPLE, GDI_ATTR_RGB_SNOWWHITE, GDI_ATTR_RGB_DARKBLACK, GDI_ATTR_RGB_SOFTWHITE },

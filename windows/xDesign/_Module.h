...
#define FACE_COUNT	6
//GDI_ATTR_RGB_LIGHTSLATE
static FACE_STYLE g_face[FACE_COUNT] = {
	{ _T("Ì«¿ÕºÚ"), GDI_ATTR_RGB_SLATEBLACK, GDI_ATTR_RGB_DARKSLATE, GDI_ATTR_RGB_LIGHTSLATE, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_LIGHTGREEN },
	{ _T("´ºÌìÂÌ"), GDI_ATTR_RGB_LIGHTGREEN, GDI_ATTR_RGB_DARKGREEN, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_GREEN },
	{ _T("ÍÁºÀ½ð"), GDI_ATTR_RGB_SOFTYELLOW, GDI_ATTR_RGB_SNOWWHITE, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_SLATEGRAY },
	{ _T("Ï²Çìºì"), GDI_ATTR_RGB_LIGHTRED, GDI_ATTR_RGB_LIGHTCYAN, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_SLATEGRAY },
	{ _T("µ­ÑÅÇà"), GDI_ATTR_RGB_LIGHTPURPLE, GDI_ATTR_RGB_SOFTSLATE, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_LIGHTBLACK },
	{ _T("¾­µä°×"), GDI_ATTR_RGB_WHITE, GDI_ATTR_RGB_SOFTGRAY, GDI_ATTR_RGB_BLACK, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_LIGHTBLACK }
};

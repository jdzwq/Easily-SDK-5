...
#define FACE_COUNT	6
//GDI_ATTR_RGB_SNOWWHITE
static FACE_STYLE g_face[FACE_COUNT] = {
	{ _T("Ì«¿ÕºÚ"), GDI_ATTR_RGB_SLATEBLACK, GDI_ATTR_RGB_DARKSLATE, GDI_ATTR_RGB_LIGHTSLATE, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_LIGHTSLATE },
	...
	{ _T("µ­ÑÅÇà"), GDI_ATTR_RGB_LIGHTPURPLE, GDI_ATTR_RGB_SNOWWHITE, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_LIGHTBLACK },

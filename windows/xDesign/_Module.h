...
static FACE_STYLE g_face[FACE_COUNT] = {
	{ _T("Ì«¿ÕºÚ"), GDI_ATTR_RGB_SLATEGRAY, GDI_ATTR_RGB_SOFTSLATE, GDI_ATTR_RGB_LIGHTSLATE, GDI_ATTR_RGB_SNOWWHITE },
	{ _T("´ºÌìÂÌ"), GDI_ATTR_RGB_LIGHTGREEN, GDI_ATTR_RGB_LIGHTCYAN, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("ÍÁºÀ½ð"), GDI_ATTR_RGB_PALEYELLOW, GDI_ATTR_RGB_BEIGEWHITE, GDI_ATTR_RGB_DARKSLATE, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("Ï²Çìºì"), GDI_ATTR_RGB_LIGHTRED, GDI_ATTR_RGB_LIGHTCYAN, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("µ­ÑÅÇà"), GDI_ATTR_RGB_LIGHTPURPLE, GDI_ATTR_RGB_SNOWWHITE, GDI_ATTR_RGB_DARKSLATE, GDI_ATTR_RGB_SOFTWHITE },
	{ _T("¾­µä°×"), GDI_ATTR_RGB_SMOKEWHITE, GDI_ATTR_RGB_SOFTGRAY, GDI_ATTR_RGB_DARKBLACK, GDI_ATTR_RGB_SOFTWHITE }
};

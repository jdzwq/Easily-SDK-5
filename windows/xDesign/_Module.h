...
static FACE_STYLE g_face[FACE_COUNT] = {
	{ _T("Ì«¿ÕºÚ"), GDI_ATTR_RGB_SLATEBLACK, GDI_ATTR_RGB_SOFTSLATE, GDI_ATTR_RGB_LIGHTSLATE, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_LIGHTSLATE },
	{ _T("´ºÌìÂÌ"), GDI_ATTR_RGB_LIGHTGREEN, GDI_ATTR_RGB_LIGHTCYAN, GDI_ATTR_RGB_MONOBLACK, GDI_ATTR_RGB_SOFTWHITE, GDI_ATTR_RGB_GREEN },

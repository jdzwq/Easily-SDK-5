...
#define GRIDPANEL_ACCEL_COUNT		1
...
void GridPanel_OnCopy(res_win_t widget)
{
	...
	widget_post_command(pdt->hGrid, COMMAND_COPY, IDC_EDITMENU, 0);
}
...
void GridPanel_OnCut(res_win_t widget)
{
	...
	widget_post_command(pdt->hGrid, COMMAND_CUT, IDC_EDITMENU, 0);
}
...
void GridPanel_OnPaste(res_win_t widget)
{
	...
	widget_post_command(pdt->hGrid, COMMAND_PASTE, IDC_EDITMENU, 0);
}
...
void GridPanel_OnUndo(res_win_t widget)
{
	...
	widget_post_command(pdt->hGrid, COMMAND_UNDO, IDC_EDITMENU, 0);
}

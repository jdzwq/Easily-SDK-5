...
void FormPanel_OnShow(res_win_t widget, bool_t bShow)
{
	...
	if (bShow)
	{
		...
		set_tool_item_icon(ilk, ICON_GROUP);
		...
		set_tool_item_icon(ilk, ICON_BORDER);
		...
		set_tool_item_icon(ilk, ICON_LABEL);

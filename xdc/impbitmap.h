...
@RETURN bitmap_t: if succeeds return bitmap resource handle, fails return NULL.
*/
EXP_API bitmap_t create_pattern_bitmap(visual_t rdc, const xcolor_t* pxc_front, const xcolor_t* pxc_back, int w, int h, const tchar_t* lay);
...
@RETURN bitmap_t: if succeeds return memory resource handle, fails return NULL.
*/
EXP_API bitmap_t create_code128_bitmap(visual_t rdc, int w, int h, const tchar_t* text);
...
@RETURN bitmap_t: if succeeds return memory resource handle, fails return NULL.
*/
EXP_API bitmap_t create_pdf417_bitmap(visual_t rdc, int w, int h, const tchar_t* text);
...
@RETURN bitmap_t: if succeeds return memory resource handle, fails return NULL.
*/
EXP_API bitmap_t create_qrcode_bitmap(visual_t rdc, int w, int h, const tchar_t* text);
#endif

...
*/
XDC_API res_win_t widget_create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, res_win_t wparent, if_event_t* pev);
...
@RETURN void: none.
*/
XDC_API	void	widget_destroy(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API	void	widget_close(res_win_t wt, int ret);
...
*/
XDC_API int		widget_get_return(res_win_t wt);
...
*/
XDC_API if_event_t* widget_get_dispatch(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_set_style(res_win_t wt, dword_t ws);
...
*/
XDC_API dword_t widget_get_style(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_set_core_delta(res_win_t wt, var_long pd);
...
*/
XDC_API var_long	widget_get_core_delta(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_set_user_delta(res_win_t wt, var_long pd);
...
*/
XDC_API var_long	widget_get_user_delta(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_set_user_id(res_win_t wt, dword_t uid);
...
*/
XDC_API dword_t widget_get_user_id(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_set_owner(res_win_t wt, res_win_t owner);
...
*/
XDC_API res_win_t widget_get_owner(res_win_t wt);
...
*/
XDC_API res_win_t widget_get_child(res_win_t wt, dword_t uid);
...
*/
XDC_API res_win_t widget_get_parent(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_set_user_prop(res_win_t wt, const tchar_t* pkey, var_long pval);
...
*/
XDC_API var_long	widget_get_user_prop(res_win_t wt, const tchar_t* pkey);
...
@RETURN var_long: return the property value if exists, otherwise return zero.
*/
XDC_API var_long	widget_del_user_prop(res_win_t wt, const tchar_t* pkey);
...
*/
XDC_API res_ctx_t widget_client_ctx(res_win_t wt);
...
@RETURN res_ctx_t: if succeeds return device context resource handle, fails return NULL.
*/
XDC_API res_ctx_t widget_window_ctx(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_release_ctx(res_win_t wt, res_ctx_t dc);
...
@RETURN void: none.
*/
XDC_API void	widget_get_client_rect(res_win_t wt, xrect_t* prt);
...
@RETURN void: none.
*/
XDC_API void	widget_get_window_rect(res_win_t wt, xrect_t* prt);
...
@RETURN void: none.
*/
XDC_API void	widget_get_window_edge(res_win_t wt, xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	widget_client_to_screen(res_win_t wt, xpoint_t* pst);
...
@RETURN void: none.
*/
XDC_API void	widget_screen_to_client(res_win_t wt, xpoint_t* pst);
...
@RETURN void: none.
*/
XDC_API void	widget_client_to_window(res_win_t wt, xpoint_t* pst);
...
@RETURN void: none.
*/
XDC_API void	widget_window_to_client(res_win_t wt, xpoint_t* pst);
...
@RETURN void: none.
*/
XDC_API void	widget_calc_border(dword_t ws, border_t* pbd);
...
@RETURN void: none.
*/
XDC_API void	widget_adjust_size(dword_t ws, xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	widget_size(res_win_t wt, const xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	widget_move(res_win_t wt, const xpoint_t* ppt);
...
@RETURN void: none.
*/
XDC_API void	widget_paint(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_update(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_enable(res_win_t wt, bool_t b);
...
@RETURN void: none.
*/
XDC_API void	widget_set_cursor(res_win_t wt,int curs);
...
@RETURN void: none.
*/
XDC_API void	widget_set_capture(res_win_t wt,bool_t b);
...
@RETURN void: none.
*/
XDC_API void	widget_create_caret(res_win_t wt, int w, int h);
...
@RETURN void: none.
*/
XDC_API void	widget_destroy_caret(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_set_focus(res_win_t wt);
...
*/
XDC_API bool_t	widget_key_state(res_win_t wt,byte_t key);
...
*/
XDC_API bool_t	widget_is_hotvoer(res_win_t wt);
...
*/
XDC_API bool_t	widget_is_editor(res_win_t wt);
...
*/
XDC_API bool_t	widget_is_valid(res_win_t wt);
...
*/
XDC_API bool_t	widget_is_child(res_win_t wt);
...
*/
XDC_API bool_t	widget_is_focus(res_win_t wt);
...
*/
XDC_API bool_t	widget_can_focus(res_win_t wt);
...
*/
XDC_API bool_t	widget_can_paging(res_win_t wt);
...
*/
XDC_API bool_t	widget_has_close(res_win_t wt);
...
@RETURN bool_t: if return nonzero indicate so, zero indicate not so.
*/
XDC_API bool_t	widget_has_size(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_post_char(res_win_t wt, tchar_t ch);
...
*/
XDC_API int		widget_send_notice(res_win_t wt, NOTICE* pnt);
...
@RETURN void: none.
*/
XDC_API void	widget_post_command(res_win_t wt, int code, int cid, var_long data);
...
*/
XDC_API int		widget_send_command(res_win_t wt, int code, int cid, var_long data);
...
@RETURN void: none.
*/
XDC_API void	widget_set_title(res_win_t wt, const tchar_t* token);
...
*/
XDC_API int		widget_get_title(res_win_t wt, tchar_t* buf, int max);
...
*/
XDC_API bool_t	widget_is_maximized(res_win_t wt);
...
@RETURN bool_t: if nonzero indicate so, zero indicate not so.
*/
XDC_API bool_t	widget_is_minimized(res_win_t wt);
...
*/
XDC_API bool_t	widget_set_subproc(res_win_t wt, dword_t sid, if_subproc_t* sub);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
XDC_API void	widget_del_subproc(res_win_t wt, dword_t sid);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
XDC_API bool_t	widget_set_subproc_delta(res_win_t wt, dword_t sid, var_long delta);
...
*/
XDC_API var_long widget_get_subproc_delta(res_win_t wt, dword_t sid);
...
*/
XDC_API bool_t	widget_has_subproc(res_win_t wt);
...
*/
XDC_API var_long widget_set_timer(res_win_t wt, int ms);
...
@RETURN void: none.
*/
XDC_API void	widget_kill_timer(res_win_t wt, var_long tid);
...
@RETURN void: none.
*/
XDC_API void	widget_attach_accel(res_win_t wt, res_acl_t acl);
...
*/
XDC_API res_acl_t widget_get_accel(res_win_t wt);
...
@RETURN res_acl_t: return accelerator resource handle if exists, otherwise return zero.
*/
XDC_API res_acl_t widget_detach_accel(res_win_t wt);
...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
XDC_API bool_t	widget_enum_child(res_win_t wt, PF_ENUM_WINDOW_PROC pf, var_long pv);
...
*/
XDC_API res_acl_t create_accel_table(const accel_t* pac, int n);
...
@RETURN void: none.
*/
XDC_API void	destroy_accel_table(res_acl_t hac);
...
@RETURN void: none.
*/
XDC_API void	get_screen_size(xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	get_desktop_size(xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	screen_size_to_pt(xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	screen_size_to_tm(xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	widget_track_mouse(res_win_t wt, dword_t mask);
...
@RETURN void: none.
*/
XDC_API void	widget_set_alpha(res_win_t wt, byte_t b);
...
*/
XDC_API byte_t	widget_get_alpha(res_win_t wt);
...
@RETURN void: none.
*/
XDC_API void	widget_set_region(res_win_t wt, res_rgn_t rgn);
#endif

#ifdef XDU_SUPPORT_CONTEXT_OPENGL
XDC_API res_glc_t widget_get_glctx(res_win_t wt);
#endif
...
*/
XDC_API int		widget_do_modal(res_win_t wt);

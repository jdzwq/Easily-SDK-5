...
@RETURN void: none.
*/
XDC_API void	draw_line_raw(res_ctx_t rdc, const xpen_t* pxp, const xpoint_t* ppt1, const xpoint_t* ppt2);
...
@RETURN void: none.
*/
XDC_API void	draw_polyline_raw(res_ctx_t rdc, const xpen_t* pxp, const xpoint_t* ppt, int n);
...
@RETURN void: none.
*/
XDC_API void	draw_polygon_raw(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, int n);
...
@RETURN void: none.
*/
XDC_API void	draw_bezier_raw(res_ctx_t rdc, const xpen_t* pxp, const xpoint_t* ppt1, const xpoint_t* ppt2, const xpoint_t* ppt3, const xpoint_t* ppt4);
...
@RETURN void: none.
*/
XDC_API void	draw_curve_raw(res_ctx_t rdc, const xpen_t* pxp, const xpoint_t* ppt, int n);
...
@RETURN void: none.
*/
XDC_API void	draw_rect_raw(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_path_raw(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const tchar_t* aa, const xpoint_t* pa, int n);
...
@RETURN void: none.
*/
XDC_API void	gradient_rect_raw(res_ctx_t rdc, const xgradi_t* pxg, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	alphablend_rect_raw(res_ctx_t rdc, const xcolor_t* pxc, const xrect_t* prt, int opacity);
...
@RETURN void: none.
*/
XDC_API void	draw_round_raw(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_ellipse_raw(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_pie_raw(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, int rx, int ry, double fang, double tang);
...
@RETURN void: none.
*/
XDC_API void	draw_arc_raw(res_ctx_t rdc, const xpen_t* pxp, const xpoint_t* ppt, int rx, int ry, double fang, double tang);
...
@RETURN void: none.
*/
XDC_API void	draw_arrow_raw(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr, int alen, double arc);
...
@RETURN void: none.
*/
XDC_API void	draw_shape_raw(res_ctx_t rdc, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr, const tchar_t* shape);
...
@RETURN void: none.
*/
XDC_API void	multi_line_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xpen_t* pxp, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_text_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, const tchar_t* txt, int len);
...
@RETURN void: none.
*/
XDC_API void	text_out_raw(res_ctx_t rdc, const xfont_t* pxf, const xpoint_t* ppt, const tchar_t* txt, int len);
...
@RETURN void: none.
*/
XDC_API void	color_out_raw(res_ctx_t rdc, const xrect_t* pxr, bool_t horz, const tchar_t* rgbstr, int len);
...
@RETURN void: none.
*/
XDC_API void	draw_var_text_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, string_t var);
...
@RETURN void: none.
*/
XDC_API void	draw_tag_text_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr tag, int page);
...
*/
XDC_API int		calc_tag_pages_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr tag);
...
@RETURN void: none.
*/
XDC_API void	draw_memo_text_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo, int page);
...
@RETURN int: return total pages.
*/
XDC_API int		calc_memo_pages_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo);
...
@RETURN void: none.
*/
XDC_API void	draw_rich_text_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr rich, int page);
...
@RETURN void: none.
*/
XDC_API void	draw_image_raw(res_ctx_t rdc, const ximage_t* pxi, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	fill_region_raw(res_ctx_t rdc, const xbrush_t* pxb, res_rgn_t rgn);
...
@RETURN void: none.
*/
XDC_API void	draw_select_raw(res_ctx_t rdc, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
XDC_API void	draw_focus_raw(res_ctx_t rdc, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
XDC_API void	draw_feed_raw(res_ctx_t rdc, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
XDC_API void	exclip_rect_raw(res_ctx_t rdc, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	inclip_rect_raw(res_ctx_t rdc, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	text_rect_raw(res_ctx_t rdc, const xfont_t* pxf, const xface_t* pxa, const tchar_t* txt, int len, xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	text_size_raw(res_ctx_t rdc, const xfont_t* pxf, const tchar_t* txt, int len, xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	text_metric_raw(res_ctx_t rdc, const xfont_t* pxf, xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	image_size_raw(res_ctx_t rdc, const ximage_t* pxi, xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	draw_line(canvas_t canv, const xpen_t* pxp, const xpoint_t* ppt1, const xpoint_t* ppt2);
...
@RETURN void: none.
*/
XDC_API void	draw_polyline(canvas_t canv, const xpen_t* pxp, const xpoint_t* ppt, int n);
...
@RETURN void: none.
*/
XDC_API void	draw_polygon(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, int n);
...
@RETURN void: none.
*/
XDC_API void	draw_rect(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_path(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const tchar_t* aa, const xpoint_t* pa, int n);
...
@RETURN void: none.
*/
XDC_API void	draw_bezier(canvas_t canv, const xpen_t* pxp, const xpoint_t* ppt1, const xpoint_t* ppt2, const xpoint_t* ppt3, const xpoint_t* ppt4);
...
@RETURN void: none.
*/
XDC_API void	draw_curve(canvas_t canv, const xpen_t* pxp, const xpoint_t* ppt, int n);
...
@RETURN void: none.
*/
XDC_API void	gradient_rect(canvas_t canv, const xgradi_t* pxg, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	alphablend_rect(canvas_t canv, const xcolor_t* pxc, const xrect_t* prt, int opa);
...
@RETURN void: none.
*/
XDC_API void	draw_round(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_ellipse(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_pie(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, float rx, float ry, double fang, double tang);
...
@RETURN void: none.
*/
XDC_API void	draw_arc(canvas_t canv, const xpen_t* pxp, const xpoint_t* ppt, float rx, float ry, double fang, double tang);
...
@RETURN void: none.
*/
XDC_API void	draw_arrow(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr, float alen, double arc);
...
@RETURN void: none.
*/
XDC_API void	draw_shape(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr, const tchar_t* shape);
...
@RETURN void: none.
*/
XDC_API void	multi_line(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xpen_t* pxp, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_text(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, const tchar_t* txt, int len);
...
@RETURN void: none.
*/
XDC_API void	text_out(canvas_t canv, const xfont_t* pxf, const xpoint_t* ppt, const tchar_t* txt, int len);
...
@RETURN void: none.
*/
XDC_API void	color_out(canvas_t canv, const xrect_t* pxr, bool_t horz, const tchar_t* rgbstr, int len);
...
@RETURN void: none.
*/
XDC_API void	draw_var_text(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, string_t var);
...
@RETURN void: none.
*/
XDC_API void	draw_tag_text(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr tag, int page);
...
@RETURN int: return total pages.
*/
XDC_API int		calc_tag_pages(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo);
...
@RETURN void: none.
*/
XDC_API void	draw_memo_text(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo, int page);
...
@RETURN int: return total pages.
*/
XDC_API int		calc_memo_pages(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr memo);
...
@RETURN void: none.
*/
XDC_API void	draw_rich_text(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, link_t_ptr rich, int page);
...
@RETURN void: none.
*/
XDC_API void	draw_image(canvas_t canv, const ximage_t* pxi, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	draw_select(canvas_t canv, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
XDC_API void	draw_focus(canvas_t canv, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
XDC_API void	draw_feed(canvas_t canv, const xcolor_t* pxc, const xrect_t* prt, int deep);
...
@RETURN void: none.
*/
XDC_API void	exclip_rect(canvas_t canv, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	inclip_rect(canvas_t canv, const xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	text_rect(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const tchar_t* txt, int len, xrect_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	text_size(canvas_t canv, const xfont_t* pxf, const tchar_t* txt, int len, xsize_t* pxr);
...
@RETURN void: none.
*/
XDC_API void	text_metric(canvas_t canv, const xfont_t* pxf, xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	image_size(canvas_t canv, const ximage_t* pxi, xsize_t* pxs);
...
@RETURN void: none.
*/
XDC_API void	draw_data(canvas_t canv, const xfont_t* pxf, const xface_t* pxa, const xrect_t* pxr, const tchar_t* data, int len, int dig, const tchar_t* type, const tchar_t* fmt, bool_t zeronull, bool_t autowrap);
...
@RETURN void: none.
*/
XDC_API void	draw_progress(canvas_t canv, const xcolor_t* pxc, const xrect_t* prt, int steps);
...
@RETURN void: none.
*/
XDC_API void	draw_ruler(canvas_t canv, const xcolor_t* pxc, const xrect_t* prt);
...
@RETURN void: none.
*/
XDC_API void	draw_corner(canvas_t canv, const xcolor_t* pxc, const xrect_t* prt);
...
@RETURN void: none.
*/
XDC_API void	draw_svg(canvas_t canv, const xrect_t* prt, link_t_ptr svg);

...
@RETURN void: none.
*/
EXP_API void 	draw_code128_raw(res_ctx_t rdc, const xcolor_t* pxc, xrect_t* pxr, const tchar_t* text, int len);
...
@RETURN void: none.
*/
EXP_API void 	draw_pdf417_raw(res_ctx_t rdc, const xcolor_t* pxc, xrect_t* pxr, const tchar_t* text, int len);
...
@RETURN void: none.
*/
EXP_API void 	draw_qrcode_raw(res_ctx_t rdc, const xcolor_t* pxc, xrect_t* pxr, const tchar_t* text, int len);

...
@RETURN void: none.
*/
EXP_API void	gradient_rect_raw(res_ctx_t rdc, const xgradi_t* pxg, const xrect_t* pxr);
...
@RETURN void: none.
*/
EXP_API void	draw_gizmo_raw(res_ctx_t rdc, const xcolor_t* pxc, const xrect_t* pxr, const tchar_t* iname);
...
@RETURN void: none.
*/
EXP_API void 	draw_code128_raw(res_ctx_t rdc, const xcolor_t* pxc, const xrect_t* pxr, const tchar_t* text, int len);
...
@RETURN void: none.
*/
EXP_API void 	draw_pdf417_raw(res_ctx_t rdc, const xcolor_t* pxc, const xrect_t* pxr, const tchar_t* text, int len);
...
@RETURN void: none.
*/
EXP_API void 	draw_qrcode_raw(res_ctx_t rdc, const xcolor_t* pxc, const xrect_t* pxr, const tchar_t* text, int len);
...
@RETURN void: none.
*/
EXP_API void	gradient_rect(canvas_t canv, const xgradi_t* pxg, const xrect_t* pxr);
...
@RETURN void: none.
*/
EXP_API void	draw_gizmo(canvas_t canv, const xcolor_t* pxc, const xrect_t* pxr, const tchar_t* iname);

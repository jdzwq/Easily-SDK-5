...
if_canvas_t* create_canvas_interface(canvas_t canv)
{
	...
	pic->pf_get_measure = get_canvas_measure;
	...
	pic->pf_draw_thumb = draw_thumb;
	pic->pf_draw_bitmap = draw_bitmap;
...
void get_visual_interface(canvas_t canv, if_visual_t* piv)
{
	...
	piv->pf_get_measure_raw = get_visual_measure;
	...
	piv->pf_draw_thumb_raw = draw_thumb_raw;
	piv->pf_draw_bitmap_raw = draw_bitmap_raw;

	piv->pf_inclip_rect_raw = inclip_rect_raw;
	piv->pf_exclip_rect_raw = exclip_rect_raw;
	piv->pf_gradient_rect_raw = gradient_rect_raw;
	piv->pf_alphablend_rect_raw = alphablend_rect_raw;
}
...
if_visual_t* create_visual_interface(visual_t rdc)
{
	...
	pic->pf_get_measure_raw = get_visual_measure;
	...
	pic->pf_draw_thumb_raw = draw_thumb_raw;
	pic->pf_draw_bitmap_raw = draw_bitmap_raw;

	pic->pf_inclip_rect_raw = inclip_rect_raw;
	pic->pf_exclip_rect_raw = exclip_rect_raw;
	pic->pf_gradient_rect_raw = gradient_rect_raw;
	pic->pf_alphablend_rect_raw = alphablend_rect_raw;

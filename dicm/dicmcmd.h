...
extern "C" {
	...
	DCM_API bool_t parse_dicm_command_from_stream(dicm_command_t* pcmd, bool_t bigEndian, dword_t maxLength, stream_t stm);

	DCM_API bool_t format_dicm_command_to_stream(dicm_command_t* pcmd, bool_t bigEndian, dword_t maxLength, stream_t stm);

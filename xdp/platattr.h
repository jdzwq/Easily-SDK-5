...
#define GDI_ICON_ALIGNCENTER	_T("alignCenter")
#define GDI_ICON_ALIGNFAR		_T("alignFar")
#define GDI_ICON_ALIGNNEAR		_T("alignNear")
#define GDI_ICON_APPEND			_T("append")
#define GDI_ICON_ARRANGECENTER	_T("arrangeCenter")
#define GDI_ICON_ARRANGELEFT	_T("arrangeLeft")
#define GDI_ICON_ARRANGERIGHT	_T("arrangeRight")
#define GDI_ICON_BACKGROUND		_T("background")
#define GDI_ICON_BEGIN			_T("begin")
#define GDI_ICON_BOOK			_T("book")
#define GDI_ICON_BORDER			_T("border")
#define GDI_ICON_CALENDAR		_T("calendar")
#define GDI_ICON_CHECK			_T("check")
#define GDI_ICON_CHECKBOX		_T("checkBox")
#define GDI_ICON_CHECKED		_T("checked")
#define GDI_ICON_CLEAR			_T("clear")
#define GDI_ICON_CLOSE			_T("close")
#define GDI_ICON_COLLAPSE		_T("collapse")
#define GDI_ICON_COPY			_T("copy")
#define GDI_ICON_COUNTER		_T("counter")
#define GDI_ICON_CUT			_T("cut")
#define GDI_ICON_DATE			_T("date")
#define GDI_ICON_DELETE			_T("delete")
#define GDI_ICON_DENSITY		_T("density")
#define GDI_ICON_DIAGRAM		_T("diagram")
#define GDI_ICON_DIALOG			_T("dialog")
#define GDI_ICON_DOC			_T("doc")
#define GDI_ICON_DOWN			_T("down")
#define GDI_ICON_EDIT			_T("edit")
#define GDI_ICON_END			_T("end")
#define GDI_ICON_EXECUTE		_T("execute")
#define GDI_ICON_EXPAND			_T("expand")
#define GDI_ICON_EXPORT			_T("export")
#define GDI_ICON_FETCH			_T("fetch")
#define GDI_ICON_FIND			_T("find")
#define GDI_ICON_FIRST			_T("first")
#define GDI_ICON_FIXED			_T("fixed")
#define GDI_ICON_FRESH			_T("fresh")
#define GDI_ICON_FOLDER			_T("folder")
#define GDI_ICON_FONTCOLOR		_T("fontColor")
#define GDI_ICON_FONTWEIGHT		_T("fontWeight")
#define GDI_ICON_FONTNAME		_T("fontName")
#define GDI_ICON_FONTSIZE		_T("fontSize")
#define GDI_ICON_FONTSTYLE		 _T("fontStyle")
#define GDI_ICON_FOREGROUND		_T("foreground")
#define GDI_ICON_GRAPH			_T("graph")
#define GDI_ICON_GRID			_T("grid")
#define GDI_ICON_GROUP			_T("group")
#define GDI_ICON_GUIDER			_T("guider")
#define GDI_ICON_HELPC			_T("helpc")
#define GDI_ICON_HELPP			_T("helpp")
#define GDI_ICON_HERF			_T("herf")
#define GDI_ICON_HOME			_T("home")
#define GDI_ICON_IMAGES			_T("images")
#define GDI_ICON_IMPORT			_T("import")
#define GDI_ICON_INPUT			_T("input")
#define GDI_ICON_INSERT			_T("insert")
#define GDI_ICON_JUDGE			_T("judge")
#define GDI_ICON_KEYBOX			_T("keyBox")
#define GDI_ICON_KEYBOXED		_T("keyBoxed")
#define GDI_ICON_LABEL			_T("label")
#define GDI_ICON_LAST			_T("last")
#define GDI_ICON_LIST			_T("list")
#define GDI_ICON_LOCATION		_T("location")
#define GDI_ICON_LOCK			_T("lock")
#define GDI_ICON_LOGO			_T("logo")
#define GDI_ICON_MAXIMIZE		_T("maximize")
#define GDI_ICON_MEMO			_T("memo")
#define GDI_ICON_MINIMIZE		_T("minimize")
#define GDI_ICON_MINUS			_T("minus")
#define GDI_ICON_MULTITEXT		_T("multiText")
#define GDI_ICON_NAVI			_T("navi")
#define GDI_ICON_NEW			_T("new")
#define GDI_ICON_NEXT			_T("next")
#define GDI_ICON_NOTE			_T("note")
#define GDI_ICON_NUMERIC		_T("numeric")
#define GDI_ICON_OPEN			_T("open")
#define GDI_ICON_ORDER			_T("order")
#define GDI_ICON_OUTPUT			_T("output")
#define GDI_ICON_PANTO			_T("panto")
#define GDI_ICON_PASTE			_T("paste")
#define GDI_ICON_PAUSE			_T("pause")
#define GDI_ICON_PHOTO			_T("photo")
#define GDI_ICON_PLUS			_T("plus")
#define GDI_ICON_PREV			_T("prev")
#define GDI_ICON_PREVIEW		_T("preview")
#define GDI_ICON_PRINT			_T("print")
#define GDI_ICON_PROCESS		_T("process")
#define GDI_ICON_PROPER			_T("proper")
#define GDI_ICON_PUSH			_T("push")
#define GDI_ICON_RADIO			_T("radio")
#define GDI_ICON_RADIOBOX		_T("radioBox")
#define GDI_ICON_RADIOED		_T("radioed")
#define GDI_ICON_REMOVE			_T("remove")
#define GDI_ICON_REDO			_T("redo")
#define GDI_ICON_RESTORE		_T("restore")
#define GDI_ICON_RICH			_T("rich")
#define GDI_ICON_SAVE			_T("save")
#define GDI_ICON_SAVEAS			_T("saveas")
#define GDI_ICON_SCATTER		_T("scatter")
#define GDI_ICON_SCHEMA			_T("schema")
#define GDI_ICON_SCREEN			_T("screen")
#define GDI_ICON_SELECTALL		_T("selectAll")
#define GDI_ICON_SELECTED		_T("selected")
#define GDI_ICON_SHAPE			_T("shape")
#define GDI_ICON_SINGLETEXT		_T("singleText")
#define GDI_ICON_SIZEHORZ		_T("sizeHorz")
#define GDI_ICON_SIZEVERT		_T("sizeVert")
#define GDI_ICON_SLIDE			_T("slide")
#define GDI_ICON_SPACEHORZ		_T("spaceHorz")
#define GDI_ICON_SPACEVERT		_T("spaceVert")
#define GDI_ICON_SPIN			_T("spin")
#define GDI_ICON_START			_T("start")
#define GDI_ICON_STATIC			_T("static")
#define GDI_ICON_STOP			_T("stop")
#define GDI_ICON_STYLE			_T("style")
#define GDI_ICON_SUM			_T("sum")
#define GDI_ICON_TABLE			_T("table")
#define GDI_ICON_TAG			_T("tag")
#define GDI_ICON_TIME			_T("time")
#define GDI_ICON_TOUCH			_T("touch")
#define GDI_ICON_TOUCHED		_T("touched")
#define GDI_ICON_TRENDS			_T("trends")
#define GDI_ICON_UNDO			_T("undo")
#define GDI_ICON_UNLOCK			_T("unlock")
#define GDI_ICON_UP				_T("up")
#define GDI_ICON_UPDATE			_T("update")
#define GDI_ICON_USER			_T("user")
#define GDI_ICON_ZOOMIN			_T("zoomIn")
#define GDI_ICON_ZOOMOUT		_T("zoomOut")

#define GDI_ICON_RECT			_T("rect")
#define GDI_ICON_ELLIPSE		_T("ellipse")
#define GDI_ICON_CROSS			_T("cross")
#define GDI_ICON_STAR			_T("star")
#define GDI_ICON_DIAMOND		_T("diamond")

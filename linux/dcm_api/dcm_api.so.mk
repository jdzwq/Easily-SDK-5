...
SRC_PATH = ~/Easily-sdk-5/api/dcm_api
OUT_PATH = ../sbin/api
...
install:
	...
	sudo cp -f $(INS_PATH)/cfg/dcm.config $(SRV_PATH)/cfg;

	if ! test -d $(SRV_PATH)/dcm; then \
	sudo mkdir $(SRV_PATH)/dcm; \
	fi
	sudo cp -f $(INS_PATH)/dcm/dcm.ini $(SRV_PATH)/dcm;
